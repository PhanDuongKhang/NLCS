...
<body>
    <header id="header">
        <div id="dheader">
            ...
            <nav class="nav">
                <ul class="menu">
                    <li><a href="index.php"><b  style="color: yellow;">TRANG CHỦ</b></a></li>
    ...
    <main>
        <div id="">
            <img src="ima/trangchu1.jpg" class="img-fluid w-100" alt="...">
        </div>


        <p style="font-size: 30px; " class="text-center"><strong>LIÊN KẾT CÁC WEBSITE</strong></p>
        <div style="margin: auto">
            <div class="dima">
                <img src="ima/trangchu2.png" alt="">
                <p>
                    <a class="text-center" href="https://moet.gov.vn/Pages/home.aspx">
            ...
            <div class="dima">
                <img src="ima/trangchu3.png" alt="">
                <p>
                    <a href="https://cfla.ctu.edu.vn/trang-chu">
                        The TOEFL Test <br>
                        https://cfla.ctu.edu.vn/trang-chu
                    </a>
                </p>
            </div>

            <div class="dima">
                <img src="ima/trangchu4.png" alt="">
                <p><a href="https://www.cambridgeenglish.org/">
                    Cambridge ESOL <br>
            ...
            <div class="dima">
                <img src="ima/trangchu5.png" alt="">
                <p>
                    <a href="http://ngoainguquocgia.moet.gov.vn/">
